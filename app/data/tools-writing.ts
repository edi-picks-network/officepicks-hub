...
export const ALL_TOOLS: ToolData[] = [
  ...
  },
  {
    ...
    pros: [
      "Industry-leading grammar and spell-check accuracy across multiple English dialects",
      "Seamless integration across browsers, Office, Google Docs, and mobile devices",
      "Tone detection and adjustment suggestions for different audiences and contexts",
      "Clarity and conciseness recommendations to improve readability",
      "Plagiarism checker with premium subscription for academic integrity",
      "Full-sentence rewrites that preserve original meaning while improving flow",
      "Goals-based writing customization (audience, style, emotion, intent)",
    ],
    cons: [
      "Premium pricing is relatively high for individual users compared to free alternatives",
      "Some suggestions can be overly rigid or contextually wrong, especially for creative writing",
      "Privacy concerns due to cloud-based text processing of all typed content",
      "Limited support for non-English languages beyond basic checks",
      "Browser extension can slow down page loading on complex websites",
    ],
    pricing: "$12/mo",
    pricingDetail: "Free (basic grammar, spelling, and tone suggestions) | Premium $12/mo (full-sentence rewrites, plagiarism detection, tone adjustments, genre-specific suggestions) | Business $15/user/mo (style guide, snippets, analytics, centralized billing) | Enterprise Custom (SSO, dedicated support, custom brand tones). All plans include browser extensions for Chrome, Firefox, Edge, and Safari, plus Microsoft Office and Google Docs integration.",
    features: [
