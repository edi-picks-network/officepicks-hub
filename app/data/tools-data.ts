...
export const DATA_TOOLS: ToolData[] = [
  {
    ...
    longDescription: "Tableau AI (powered by Einstein GPT and Salesforce Data Cloud) represents the next evolution of business intelligence, embedding generative AI natively into Tableau's market-leading analytics platform. As of 2026, Tableau AI serves over 86,000 customer accounts including 90% of the Fortune 500, processing more than 10 billion data queries daily across its cloud infrastructure. The platform's flagship Ask Data feature has been upgraded with contextual awareness — it now understands multi-turn conversations, allowing users to refine queries like "Show me Q3 regional sales" followed by "only the western region and filter for above-target accounts" without re-specifying context. Tableau Pulse 2.0 uses anomaly detection algorithms to proactively surface metric changes, automatically generating natural-language explanations for variance (e.g., "West Coast revenue dropped 12% this week driven by a 34% decline in the SaaS segment, primarily from three churned accounts"). The new VizQL Data Story feature transforms any dashboard into a narrated slide deck, complete with AI-generated insights, trend highlights, and recommendation annotations — cutting report preparation time by 70% according to internal benchmarks. Tableau's Einstein Copilot for Analytics enables conversational dashboard creation: users can describe what they want in plain language ("Compare monthly active users by plan type for the last 6 quarters as a grouped bar chart") and the AI builds the visualization automatically. The platform now supports real-time natural language querying of streaming data sources including Snowflake, Databricks, and Redshift, with sub-second response times for most query patterns. Enterprise governance features include automated data classification, lineage tracking, and AI-generated data dictionary descriptions for every field in the catalog.",
    pros: [
      "Multi-turn conversational Ask Data allows users to refine queries naturally without re-specifying context",
      "Tableau Pulse 2.0 anomaly detection proactively surfaces metric changes with auto-generated natural-language explanations of variance",
      "VizQL Data Story transforms dashboards into narrated slide decks with AI insights, cutting report prep time by 70%",
      "Einstein Copilot enables conversational dashboard creation from natural language descriptions",
      "Real-time natural language querying of streaming data from Snowflake, Databricks, and Redshift with sub-second responses",
      "Automated data classification, lineage tracking, and AI-generated data dictionaries for enterprise governance",
    ],
    cons: [
      "Requires existing Tableau Cloud subscription — no standalone AI-only purchase option for non-Tableau users",
      "AI capabilities vary by region, with some advanced features (Einstein Copilot, VizQL Data Story) still limited to US and EU data centers",
      "Explorer plan at $75/user/month combined with Viewer seats at $35/user/month makes it expensive for small teams compared to self-service alternatives like Julius AI or Metabase",
      "Natural language accuracy degrades significantly with poorly modeled data or ambiguous field names requiring upfront data governance investment",
      "Einstein Copilot currently supports English-only queries with German and Japanese support in beta as of mid-2026",
    ],
    pricing: "$75/mo",
    pricingDetail: "Tableau AI features are included with Tableau Cloud subscriptions. Explorer plan at $75/user/month (billed annually, $90 month-to-month) includes full AI capabilities including Ask Data, Pulse, Einstein Copilot, and VizQL Data Story. Viewer plan at $35/user/month (billed annually, $42 month-to-month) provides read-only access with Pulse AI insights delivery. Creator plan at $115/user/month adds data preparation and governed self-service authoring with AI-assisted data modeling. All plans include Salesforce Data Cloud integration. Enterprise custom pricing available with dedicated AI compute capacity, private data lake connectivity, and SLA guarantees. Annual billing discounts apply.",
    features: [
