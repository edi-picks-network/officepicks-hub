...
export const ALL_TOOLS: ToolData[] = [
...

  {
    ...
    pros: [
      ...
      "Full articulation: tilt (-90° to +90°), swivel (±90°), and 360° portrait/landscape rotation",
      "Integrated cable routing channel with built-in cable ties for clean, tangle-free desk management",
    ],
    cons: [
    ...
    features: [
      "Gas-spring height adjustment with adjustable tension knob for personalized lift resistance",
      "Tilt range: -90° (fully downward) to +90° (fully upward) for ergonomic viewing angles",
...

  {
    ...
    pros: [
      "Truly independent dual-arm movement with full gas-spring height adjustment for each monitor",
      "Sturdy steel construction with reinforced joints provides rock-solid stability even at full extension",
      "Comprehensive cable management for two monitors with integrated raceway and Velcro straps",
      "Affordable entry into dual-monitor ergonomics at under $130 with premium feature set",
      "Wide compatibility with curved and flat monitors from 13 to 32 inches up to 17.6 lbs each",
      "Smooth portrait/landscape 360-degree rotation per arm enables flexible multi-display layouts",
      "Quick 15-minute assembly with included hex tool and pre-assembled components",
    ],
    cons: [
      "Base requires minimum 2.5-inch desk depth clearance which may not fit all desk edge designs",
      "Larger footprint than single-arm solutions requiring wider desk for optimal arm positioning",
      "Tension may loosen slightly after 6-12 months of heavy use -- periodic re-tightening recommended",
      "Cable routing channels are narrower than premium alternatives, difficult for thick HDMI cables",
    ],
    pricing: "$129.99",
    pricingDetail: "Includes dual arms, clamp/grommet base, VESA plates, screws, cable ties, and hex tool; 3-year warranty provided by VIVO.",
    features: [
      "Independent gas-spring height adjustment, tilt, and swivel for each monitor arm",
      "Portrait/landscape 360-degree rotation per monitor for flexible orientation switching",
      "VESA 75x75mm and 100x100mm compatibility supporting most monitors up to 32 inches",
      "Cable raceway with integrated Velcro straps and dedicated cable exit ports per arm",
      "Adjustable center arm spacing from 12 to 24 inches to accommodate varying monitor sizes",
      "Desk thickness range: 0.98 to 3.5 inches for both C-clamp and grommet mounting options",
      "Weight capacity of 17.6 lbs (8 kg) per arm with 35.2 lbs total system capacity",
      "Full articulation: tilt (-90 to +90 degrees), swivel (+/-90 degrees), and height (12-inch range)",
      "Dual-mount system: heavy-duty C-clamp and grommet base included in box",
      "Low-profile design with matte black powder-coated finish for professional appearance",
      "Reinforced steel-aluminum hybrid construction with anti-corrosion coating",
      "Tool-free monitor attachment via quick-release VESA plate system",
    ],
