...
export const ALL_TOOLS: ToolData[] = [
...

  {
    ...
    reviewCount: 3240,
    icon: MousePointer2,
    description: "A premium, solid-wood desktop riser that elevates your monitor for ergonomic alignment and adds refined aesthetic appeal.",
    longDescription: `Crafted from sustainably sourced walnut or maple, the Grovemade Desk Riser features precision-milled edges, a non-slip rubber base, and subtle chamfered corners for visual lightness. Its 4.5-inch height promotes neutral neck posture and creates valuable under-monitor storage space for notebooks, keyboards, or accessories. Designed in Portland and assembled in the USA, it’s built to last decades—not just years.`,
    pros: [
      "Exceptional build quality and material authenticity",
      "Improves posture and reduces neck strain",
      "Timeless design complements both modern and traditional offices",
      "Doubles as discreet under-monitor storage",
    ],
    cons: [
      "Premium price point may deter budget-conscious buyers",
      "No built-in cable management",
      "Limited height adjustability (fixed at 4.5\")",
    ],
    pricing: "$299.00",
    pricingDetail: "One-time purchase; available in walnut, maple, or black walnut finishes.",
    features: [
      "Solid hardwood construction",
      "Non-slip silicone base pads",
      "Chamfered edge detailing",
      "4.5\" fixed lift height",
      "Made in USA",
      "FSC-certified wood options",
    ],
    useCase: "Best for professionals seeking long-term ergonomic upgrades and design-forward minimalism while less ideal for users needing variable height adjustment or frequent portability.",
    alternatives: ["rain-design-i-level", "roost-laptop-stand", "twelve-south-bookshelf"],
    scoreBreakdown: { features: 92, reviews: 89, momentum: 85, popularity: 78 },
    userQuotes: [
      { role: "UX Designer", company: "Studio Nova", quote: "It’s not just a riser—it’s the centerpiece of my desk. My shoulders stopped aching within a week." },
      { role: "Remote Team Lead", company: "Veridian Labs", quote: "Clients always comment on how polished our video calls look—this riser makes my setup feel intentional and professional." },
    ],
  },
...

  {
    ...
    description: "A powerful, privacy-first knowledge management tool built on plain-text Markdown files.",
    longDescription: `Obsidian empowers users to build a personalized second brain using bidirectional links, graph views, and community plugins. It runs locally by default—no cloud syncing unless explicitly enabled—making it ideal for security-conscious professionals and researchers. Its extensible ecosystem supports daily notes, project planning, literature review, and complex information architecture without vendor lock-in.`,
    pros: [
      "Fully offline-capable with optional sync",
      "Unmatched linking and graph visualization",
      "Rich plugin library (including AI-powered assistants)",
      "Open file format ensures long-term data ownership",
    ],
    cons: [
      "Steeper learning curve for non-technical users",
      "No native mobile editing (read-only on iOS/Android)",
      "Cloud sync requires paid Obsidian Sync or third-party setup",
    ],
    pricing: "Free core app; Sync $8/mo or $96/yr; Publish $12/mo or $144/yr",
    pricingDetail: "Core functionality is free forever. Obsidian Sync enables encrypted cross-device sync; Publish allows secure, customizable web publishing of notes.",
    features: [
      "Bi-directional linking",
      "Local-first architecture",
      "Graph view & backlinking",
      "Community plugins (e.g., Tasks, Dataview, Calendar)",
      "Markdown-based plain-text storage",
      "Customizable themes and CSS snippets",
    ],
    useCase: "Best for knowledge workers, academics, and developers who value data sovereignty and deep customization while less ideal for teams needing out-of-the-box collaboration or real-time co-editing.",
    alternatives: ["notion", "ticktick", "sun-sama"],
    scoreBreakdown: { features: 92, reviews: 89, momentum: 94, popularity: 87 },
    userQuotes: [
      { role: "Research Scientist", company: "Stanford Neuroinformatics Lab", quote: "Obsidian replaced three separate tools—we use it for lab notebooks, paper annotations, and grant writing—all searchable and interlinked in one place." },
      { role: "UX Designer", company: "Figma (Contractor)", quote: "I migrated my entire design system documentation into Obsidian. The ability to link components, research findings, and user flows has cut our onboarding time in half." },
    ],
  },

  {
    ...
    reviewCount: 7820,
    icon: LayoutDashboard,
    description: "An all-in-one workspace for notes, tasks, wikis, and databases with flexible block-based editing.",
    longDescription: `Notion combines note-taking, task management, project tracking, and collaborative documentation into a single, highly customizable platform. Its drag-and-drop interface and relational database structure enable teams to build tailored workflows—from sprint planning to HR handbooks—without coding. Real-time collaboration, granular permissions, and robust API integrations make it a central hub for modern remote teams.`,
    pros: [
      "Extremely flexible templating and database relationships",
      "Real-time collaboration with rich commenting",
      "Strong mobile apps and offline support",
      "Vast template gallery and active community",
    ],
    cons: [
      "Performance degrades with very large workspaces (>10K pages)",
      "Limited offline editing capabilities on mobile",
      "Privacy concerns due to cloud-hosted data by default",
    ],
    pricing: "Free for individuals; Pro $8/mo; Business $15/mo per seat; Enterprise custom",
    pricingDetail: "Free plan includes unlimited pages and blocks but restricts version history (7 days) and collaborators (up to 10). Pro adds unlimited version history, advanced permissions, and priority support.",
    features: [
      "Modular block-based editor",
      "Relational databases with filters/sorts",
      "Templates and page duplication",
      "Team workspaces with role-based access",
      "Native calendar and timeline views",
      "API and Zapier/Make integrations",
    ],
    useCase: "Best for hybrid and remote teams seeking unified documentation and lightweight project management while less ideal for users requiring strict data residency compliance or ultra-high-volume text editing.",
    alternatives: ["obsidian", "sun-sama", "todoist"],
    scoreBreakdown: { features: 93, reviews: 86, momentum: 91, popularity: 95 },
    userQuotes: [
      { role: "Product Manager", company: "Shopify", quote: "We run our entire product roadmap, OKRs, and sprint retrospectives in Notion—it’s the single source of truth for engineering and marketing alignment." },
      { role: "Content Strategist", company: "HubSpot", quote: "Our editorial calendar, SEO tracker, and contributor guidelines live in one Notion workspace. Editors update status in real time, and leadership gets auto-generated weekly summaries." },
    ],
  },
