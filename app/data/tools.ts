...
export const ALL_TOOLS: ToolData[] = [
...

  {
    ...
    pros: [
      "Dual-motor system lifts 305 lbs smoothly and quietly (≤45 dB)",
      "Zero-wobble performance even at max height (tested with dual 32\" monitors + accessories)",
      "Four programmable height presets with auto-save and quick-tap recall",
      "Built-in anti-collision sensors stop and reverse movement on contact",
      "USB-C firmware update port enables future feature upgrades",
      "Cable management tray includes integrated Velcro straps and dual grommet holes",
      "15,000-cycle motor warranty--2x industry standard",
    ],
    cons: [
      "Desktop not included--requires separate purchase ($199-$349 depending on material)",
      "Control box lacks Bluetooth; relies on wired keypad only",
      "Limited color options--only matte black or white leg finishes available",
      "No built-in power outlet or USB charging ports",
    ],
    pricing: "$699-$949",
    ...
    features: [
      "Dual-motor lift system with 305 lb capacity",
      "Height range: 24.2\"-50\"",
      "LCD digital keypad with 4 memory presets",
      "Collision detection with auto-reverse safety",
      "Integrated cable management tray with Velcro straps",
      "30mm thick desktop compatibility (MDF, bamboo, or laminate)",
      "Reinforced C-frame with 16mm carbon steel legs",
      "USB-C firmware update port",
      "Programmable speed settings (3 levels)",
      "Anti-tip design certified to BIFMA X5.5 standards",
      "15,000-cycle motor warranty",
      "Tool-free desktop mounting hardware included",
    ],
    ...
    userQuotes: [
      { role: "UX Designer", company: "Lumen Studios", quote: "Switching from a single-motor desk to the E7 cut my daily fatigue by half--the silent lift lets me adjust during client calls without awkward pauses." },
      { role: "Physical Therapist", company: "PostureWell Clinic", quote: "I recommend the E7 to patients with chronic back pain because its precise height calibration helps them hit optimal elbow/wrist angles consistently." },
      { role: "Freelance Video Editor", company: "FrameShift Media", quote: "After two years of heavy use--dual 4K monitors, capture cards, audio interface--the desk hasn't lost a millimeter of stability or speed." },
    ],
  },
