...
export const IMAGE_TOOLS: ToolData[] = [
  ...
  },
  {
    ...
    pros: [
      "Best-in-class prompt adherence and text rendering — generates exactly what you describe",
      "Seamless ChatGPT integration for conversational image editing and refinement",
      "Strong safety guardrails and content moderation prevent misuse",
      "Accurate text rendering in images, ideal for logos, signage, and mockups",
      "Multi-turn conversation enables iterative design without leaving chat",
      "High-resolution output up to 1792x1024 for print-quality results",
      "Excellent at generating photorealistic images from detailed prompts",
    ],
    cons: [
      "Less artistic stylization compared to Midjourney — outputs tend toward photorealism",
      "Limited fine-grained control over composition parameters like aspect ratio and seed",
      "No dedicated standalone API — requires ChatGPT Plus or Enterprise subscription",
      "Cannot generate or edit images outside the ChatGPT interface",
      "Slower generation speed compared to some dedicated image tools",
    ],
    pricing: "$20/mo",
    pricingDetail: "ChatGPT Plus $20/mo (includes full DALL-E 3 access, unlimited generations within fair use) | Team $25/user/mo | Enterprise Custom (priority access, SSO, dedicated support). DALL-E 3 is not available as a standalone subscription — it is included with all paid ChatGPT plans. API access available separately through OpenAI's API platform with pay-as-you-go pricing.",
    features: [
      ...
      "Style and mood adjustments through natural language prompts",
      "Seamless editing of specific image regions via chat commands",
    ],
    ...
    userQuotes: [
      ...
      { role: "Creative Director", company: "Digital Agency", quote: "The prompt adherence is incredible — we get exactly what we envision 90% of the time. It saves hours of back-and-forth with designers." },
      { role: "Content Strategist", company: "HubSpot", quote: "For blog thumbnails and social media graphics, DALL-E 3 integrated with ChatGPT is the fastest workflow I have ever used." },
    ],
  },
  {
    id: "stable-diffusion",
